...
def run_challenge(params):
    ...
    try:
        ...
        j3_init_rad = math.radians(133)

        raw2 = _actuator_controller.relative_joint_angle_to_raw(joint2_id, -j2_init_rad)
        raw35 = _actuator_controller.relative_joint_angle_to_raw(joint3_id, j3_init_rad)

        _actuator_controller.set_position(joint2_id, int(raw2))
        _actuator_controller.set_velocity(joint3_id, int(raw35))
        time.sleep(0.5)
